...
export const BannerSecondary = ({event}: any) => {
    ...
    return (
        ...
        <div className="w-full p-4 h-[150px] relative bg-black bg-opacity-25 rounded-3xl shadow bg-cover bg-center" style={{backgroundImage: `url(${image})`}}>
