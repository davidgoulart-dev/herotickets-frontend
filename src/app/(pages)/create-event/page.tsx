        ...
        <div className="container m-auto">
            <div className="grid md:grid-cols-2 gap-1  grid-cols-1 p-8">
                <div className="mb-4 pr-6 border-r-2 border-[#61D9DE]">
                    ...
                    <Input title="Titulo" placeholder="Insira o nome do seu evento" type="text" />
                    <Input title="Endereço" placeholder="Insira o endereço do seu evento" type="text" />
                    <Input title="Cupom" placeholder="Insira o cupom" type="text" />
                
                    <div className="grid grid-cols-2 gap-3">

<Input title="Data" placeholder="Insira o endereço do seu evento" type="date" />
<Input title="Horário" placeholder="Insira o horário do seu evento" type="number" />


</div>
             
<p className="text-blue text-base font-medium">Crie o seu próprio evento da maneira que você preferir! :)</p>
...
<div className=" mt-4">
    ...
    <p className="text-neutral-500 text-sm font-light">Caso seu evento seja gratuito, o campo deverá ficar vazio. Caso haja mais de um setor, basta adicionar a seção. Se houver cupom promocional, basta colocar o código no campo “cupom”.</p>

</div>
<div className="grid grid-cols-5 gap-2">
    <Input title="Preço" placeholder="R$ 0,00" type="text" className="col-span-2" />
    <Input title="Setor" placeholder="Insira o nome do setor" type="text" className="col-span-3" />


</div>
<Input title="Descrição" placeholder="Insira o nome do setor" type="textarea" className="col-span-3" />
                ...
                <div className="mb-4 ml-4 mr-3">
                    ...
                    <div className=" my-4">
                        ...
                        <p className="text-neutral-500 text-sm font-light">Insira o Mapa do Evento indicando os setores</p>
